...
logRoute.post('/addlog', [
    validateJWT,
    check('users', 'El campo users es obligatorio y debe ser un string').not().isEmpty().isString(),
    check('action', 'El campo action es obligatorio y debe ser un string').not().isEmpty().isString(),
    check('information', 'El campo information es obligatorio y debe ser un string').not().isEmpty().isString(),
